module.exports = {　//此项是用来告诉eslint找当前配置文件不能往父级查找　
  root: true,//此项是用来指定javaScript语言类型和风格，sourceType用来指定js导入的方式，默认是script，此处设置为module，指某块导入方式
...
rules: {　　//设置 每行最多能出现几个属性  以下配置是每行超过10个属性 就会报错
  ...
  'semi': [2, 'always'],
  "semi-spacing": 0,　//大括号前 是否需要空格隔开
  'space-before-blocks': [2, 'always'],
  'space-before-function-paren': [2, 'never'],
  'space-in-parens': [2, 'never'],　　//+号和：号前后是否所需要 空格 隔开
  'space-infix-ops': 2,
  'space-unary-ops': [2, {
    'words': true,
    'nonwords': false
